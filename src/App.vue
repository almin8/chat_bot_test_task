      ...
      <div class="v" v-if="startBot">
        ...
        >
          ...
          >
            ...
            <div
              v-if="el.id == 'my'"
              class="w-auto text-right bg-red-400 break-words p-2 rounded-bl-2xl rounded-t-lg max-w-fit"
            >
              {{ el.text }}
            </div>
            <div
            ...
            >
              <div
                class="bg-yellow-400 w-auto break-words p-2 rounded-r-2xl rounded-t-lg"
              >
                {{ el.text }}
              </div>
              <div
